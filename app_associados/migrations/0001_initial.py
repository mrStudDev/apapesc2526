# Generated by Django 5.2.3 on 2025-06-22 23:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recolhe_inss', models.CharField(blank=True, choices=[('Sim', 'Sim'), ('Não', 'Não'), ('Undefined ', 'Undefined')], default='Não declarado', max_length=50, null=True)),
                ...
                ('bolsa_familia', models.CharField(blank=True, choices=[('Já recebeu', 'Já recebeu'), ('Nunca recebeu', 'Nunca recebeu'), ('Undefined ', 'Undefined')], default='Não declarado', max_length=50, null=True, verbose_name='Bolsa Família')),
                ...
                ('status', models.CharField(blank=True, choices=[('associado_lista_ativo', 'Associado Lista Ativos(a)'), ('associado_lista_aposentado', 'Associado Lista Aposentados(a)'), ('candidato', 'Candidato(a)'), ('cliente_especials', 'Cliente Especial'), ('desassociado', 'Desassociado(a)')], default='Candidato(a)', max_length=40, null=True, verbose_name='Status')),
                ...
                ('associacao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='associados_associacao', to='app_associacao.associacaomodel', verbose_name='Associação')),
                ('municipio_circunscricao', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='municipios_associados', to='app_associacao.municipiosmodel', verbose_name='Município de Circunscrição/Atuação')),
                ...
                ('reparticao', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='reparticoes_associados', to='app_associacao.reparticoesmodel', verbose_name='Repartição')),
                ...
                ('petrechos_pesca', models.ManyToManyField(blank=True, to='app_associados.petrechopesca', verbose_name='Petrechos de Pesca')),
            ],
        ),
    ]
